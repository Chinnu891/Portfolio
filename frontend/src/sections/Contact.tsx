                ...
                <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-xs text-gray-400 dark:text-gray-500 font-medium">
                                            {label}
                                            {isEmail && copiedEmail && (
                                                <span className="text-emerald-500 dark:text-emerald-400 ml-2 animate-pulse font-semibold">
                                                    (Copied!)
                                                </span>
                                            )}
                                        </div>
                    ...
                    >
                        ...
                        <a
                            ...
                            className="w-full py-3.5 bg-white text-primary-600 font-bold rounded-2xl text-center hover:bg-primary-50 transition-colors shadow-lg text-sm flex items-center justify-center gap-2"
                        >
                            {copiedEmail ? '✓ Email Copied to Clipboard!' : 'Send Me an Email →'}
                        </a>
                    </motion.div>
                </div>
